...
import { initContactPageSection } from '../features/general/ContactSection.js';
import { contactSectionData } from '../data/contactSectionData.js';
...
let contactSectionInstance = null;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (preloaderInstance && typeof preloaderInstance.mount === 'function') {
  ...
  // inside customCursorInstance.element -- same as main.js / about.js.
  ...
  if (contactSectionInstance && typeof contactSectionInstance.mount === 'function') {
    contactSectionInstance.mount();
  }
  ...
  window.addEventListener('unload', () => {
    ...
    if (preloaderScrollLockInstance && typeof preloaderScrollLockInstance.destroy === 'function') {
      preloaderScrollLockInstance.destroy();
    }
    ...
    if (contactSectionInstance && typeof contactSectionInstance.destroy === 'function') {
      contactSectionInstance.destroy();
    }
